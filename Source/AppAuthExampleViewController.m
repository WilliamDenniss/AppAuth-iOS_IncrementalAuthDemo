...
- (void)updateUI {
  ...
  _incrementalAuthButton.enabled = [_authState isAuthorized];
  ...
  OIDAuthorizationRequest *request =
      [[OIDAuthorizationRequest alloc] initWithConfiguration:configuration
                                                ...
                                                clientSecret:clientSecret
                                                      scopes:@[ OIDScopeOpenID, OIDScopeProfile, @"https://www.googleapis.com/auth/contacts"  ]
...
- (IBAction)incrementalAuth:(nullable id)sender {
  // builds authentication request
  ...
  [self logMessage:@"Initiating incremental authorization request with scope: %@", incrementalAuthorizationRequest.scope];
  ...
  appDelegate.currentAuthorizationFlow =
      ...
      if (success) {
        [self logMessage:@"Incremental authorization succeeded"];
      }
      else {
        [self logMessage:@"Incremental authorization failed with : %@\n\n%@", error.localizedDescription, error];
      }
  }];
}
